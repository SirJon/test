(function(){
  ...
  const writeTime = function(hourItem, minutesItem, secondsItem){  
    const Data = new Date();
  ...
  const creatTime = function(){
    return (
      "<div class='time'><ul class='time__list'><li id='hour' class='time__item'>00</li><li class='time__item time__item--delimiter'>:</li><li id='minutes' class='time__item'>00</li><li class='time__item time__item--delimiter'>:</li><li id='seconds' class='time__item'>00</li></ul></div>"
    );
  };

  const render = function(container, position, text){
